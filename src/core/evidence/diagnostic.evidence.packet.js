...
function buildDiagnosticEvidencePacket(input = {}) {
  ...
  const deterministic = {
    vehicleProfile: input.deterministicProfile || null,
  ...
  return {
    ...
    vehicle: {
      ...
      year: finiteNumber(Number(vehicle.year)),
      ...
      mileage: finiteNumber(Number(input.mileage))
    },
    observations: {
      customer: customerObservations,
      mechanic: mechanicObservations,
      completedWork
    },
    dtcs,
